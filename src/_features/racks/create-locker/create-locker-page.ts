...
export class CreateLockerPage {
  ...
  type: LockerType;
  lockerDimension: LockerDimension;
  fridgeDimension: LockerDimension;
  fridgeLockersDimensions: LockerDimension[] = [];
  ...
  private static getDefaultLockerDimensions(): LockerDimension {
    return <LockerDimension>{x: 4, y: 4};
  }

  private static getDefaultFridgeDimensions(): LockerDimension {
    ...
    return <LockerDimension>{x: 1, y: 5};
  }

  private static getDefaultFridgeLockersDimensions(): Array<LockerDimension> {
    let def = new Array(CreateLockerPage.getDefaultFridgeDimensions().y);
    def.fill(CreateLockerPage.getDefaultFridgeDimensions());
    return <LockerDimension[]>def;
  }
